...
test: clean check-syntax-errors check-style
	openfisca test --country-package openfisca_france_territoires openfisca_france_territoires/tests

serve-local: build
	openfisca serve --country-package openfisca_france_territoires
